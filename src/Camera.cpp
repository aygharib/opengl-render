...
auto Camera::process_keyboard(Camera_Movement direction, float deltaTime)
    -> void {
...
auto Camera::process_mouse_movement(double xoffset, double yoffset,
                                    GLboolean constrainPitch) -> void {
