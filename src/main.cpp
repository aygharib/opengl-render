...
auto create_VAO() -> unsigned int {
    ...
    auto vertices = std::array<float, 180>{
        -0.5F, -0.5F, -0.5F, 0.F, 0.F, 0.5F,  -0.5F, -0.5F, 1.F, 0.F,
        0.5F,  0.5F,  -0.5F, 1.F, 1.F, 0.5F,  0.5F,  -0.5F, 1.F, 1.F,
        -0.5F, 0.5F,  -0.5F, 0.F, 1.F, -0.5F, -0.5F, -0.5F, 0.F, 0.F,

        -0.5F, -0.5F, 0.5F,  0.F, 0.F, 0.5F,  -0.5F, 0.5F,  1.F, 0.F,
        0.5F,  0.5F,  0.5F,  1.F, 1.F, 0.5F,  0.5F,  0.5F,  1.F, 1.F,
        -0.5F, 0.5F,  0.5F,  0.F, 1.F, -0.5F, -0.5F, 0.5F,  0.F, 0.F,

        -0.5F, 0.5F,  0.5F,  1.F, 0.F, -0.5F, 0.5F,  -0.5F, 1.F, 1.F,
        -0.5F, -0.5F, -0.5F, 0.F, 1.F, -0.5F, -0.5F, -0.5F, 0.F, 1.F,
        -0.5F, -0.5F, 0.5F,  0.F, 0.F, -0.5F, 0.5F,  0.5F,  1.F, 0.F,
        ...
        -0.5F, -0.5F, -0.5F, 0.F, 1.F, 0.5F,  -0.5F, -0.5F, 1.F, 1.F,
        0.5F,  -0.5F, 0.5F,  1.F, 0.F, 0.5F,  -0.5F, 0.5F,  1.F, 0.F,
        -0.5F, -0.5F, 0.5F,  0.F, 0.F, -0.5F, -0.5F, -0.5F, 0.F, 1.F,
...
auto render(Shader& shader_program, unsigned int VAO, unsigned int texture1,
            unsigned int texture2) -> void {
    glClearColor(0.2F, 0.3F, 0.3F, 1.F);
    // clear depth buffer before each render to clear previous depth data
    // (similar to clearing previous color buffer)
    ...
    glActiveTexture(
        GL_TEXTURE1); // activate the texture unit first before binding texture
    ...
    auto projection = glm::perspective(glm::radians(camera.get_zoom()),
                                       800.F / 600.F, 0.1F, 100.F);

    // Send matrices to shader (this is usually done each frame since
    ...
    int i = 0;
    std::ranges::for_each(std::as_const(cube_positions),
                          [&i, &shader_program](const auto& cube_position) {
                              // create Model matrix
...
auto main() -> int {
    ...
    const auto texture1 =
        create_texture("./resources/textures/container.jpg", false);
    const auto texture2 =
        create_texture("./resources/textures/grunge-scratch.png", true);
